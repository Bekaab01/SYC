<?php
// Admin Dashboard - Secure Access Required
...
$all_associations = [];
try {
    $stmt = $pdo->query("SELECT * FROM associations ORDER BY FIELD(registration_status, 'pending', 'manual_review', 'approved', 'rejected'), created_at DESC");
...
<body>
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <a href="../../spotyourcargo.com/public_html/index.php" class="sidebar-logo">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="#" data-tab="associations"><i class="fas fa-handshake"></i> Association Management</a></li>
    ...
    <div class="main-content">
        ...
        <header class="top-header">
            ...
            <div class="header-actions">
                ...
                <a href="?logout=1" class="action-btn danger" onclick="return confirm('Are you sure you want to logout?')">
        ...
        <div class="dashboard-content">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="status-badge active"><?php echo ucfirst($user['user_type']); ?></span>
                                    </td>
                                    <td>
            ...
            <!-- Associations Tab -->
            <div id="associations" class="tab-content">
                <div class="data-table">
                    <div class="table-header">
                        <h3>Association Management</h3>
                        <a href="associations_pending.php" class="action-btn" style="margin-left: auto;">
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($all_associations as $association): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="association_view.php?id=<?php echo $association['id']; ?>" class="action-btn">
