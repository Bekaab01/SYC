...
// Function to generate unique Spot Your Cargo ID
            ...
            if (!$user['email_verified']) {
                ...
                if ($user['user_type'] === 'association') {
                    ...
                    if ($user['user_type'] === 'transitor') {
                        header('Location: ' . $appUrl . '/transitor-dashboard.php');
                    } else {
                        header('Location: ' . $appUrl . '/shipper-dashboard.php');
                    }
                }
                exit();
            }
...
<body class="access-page">
    ...
    <header class="access-header" id="accessHeader">
        <a href="index.php" class="access-logo">
            ...
            <span class="access-logo-text">Spot Your Cargo<span class="access-logo-dot">.</span></span>
        </a>
    ...
    <div class="auth-container">
        ...
        <div class="auth-left">
            ...
            <div class="auth-left-content">
                <h2>Welcome to Spot Your Cargo</h2>
        ...
        <div class="auth-right">
            <div class="auth-form-container">
                ...
                <div class="role-switcher" id="roleSwitcher">
                    <button type="button" class="role-option active" data-role="shipper">Shipper</button>
                    <button type="button" class="role-option" data-role="association">Association</button>
                    <button type="button" class="role-option" data-role="transitor">Transitor</button>
                </div>
                ...
                <!-- Login Form -->
                <form class="auth-form <?php echo $login_active ? 'active' : ''; ?>" id="loginForm" method="POST" action="access.php" novalidate>
                    <input type="hidden" name="login" value="1">

                    <div id="login-error" class="global-error" style="display: none;">
                        <i class="fas fa-exclamation-circle"></i>
                        <span id="login-error-text">Invalid credentials</span>
                    </div>

                    <div id="login-success" class="global-success" style="display: none;">
                        <i class="fas fa-check-circle"></i>
                        <span id="login-success-text">Login successful!</span>
                    </div>

                    <div class="form-group">
                        <label for="login-identifier">Email or Phone</label>
                        <input type="text" id="login-identifier" name="identifier" placeholder="Enter your email or phone" required>
                        <small id="identifier-helper" class="form-text text-muted">Enter your shipper email or phone number</small>
                    </div>
                ...
                <form class="auth-form <?php echo $signup_active ? 'active' : ''; ?>" id="signupForm" method="POST" action="access.php">
                    ...
                    <div id="role-specific-fields">
                        <!-- Shipper Fields -->
                        <div class="role-fields" id="shipper-fields" style="display: none;">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="signup-tin">TIN (Tax Identification Number)</label>
                                <input type="text" id="signup-tin" name="tin" placeholder="Enter your TIN" value="<?php echo isset($_POST['tin']) && isset($_POST['signup']) ? htmlspecialchars($_POST['tin']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-contact-person">Contact Person</label>
                                <input type="text" id="signup-contact-person" name="contact_person" placeholder="Enter contact person name" value="<?php echo isset($_POST['contact_person']) && isset($_POST['signup']) ? htmlspecialchars($_POST['contact_person']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-business-category">Business Category</label>
                                <select id="signup-business-category" name="business_category">
                                    <option value="">Select business category</option>
                                    <option value="manufacturing" <?php echo (isset($_POST['business_category']) && $_POST['business_category'] === 'manufacturing') ? 'selected' : ''; ?>>Manufacturing</option>
                                    <option value="retail" <?php echo (isset($_POST['business_category']) && $_POST['business_category'] === 'retail') ? 'selected' : ''; ?>>Retail</option>
                                    <option value="wholesale" <?php echo (isset($_POST['business_category']) && $_POST['business_category'] === 'wholesale') ? 'selected' : ''; ?>>Wholesale</option>
                                    <option value="import_export" <?php echo (isset($_POST['business_category']) && $_POST['business_category'] === 'import_export') ? 'selected' : ''; ?>>Import/Export</option>
                                    <option value="other" <?php echo (isset($_POST['business_category']) && $_POST['business_category'] === 'other') ? 'selected' : ''; ?>>Other</option>
                                </select>
                            </div>
                        </div>

                        <!-- Association Fields -->
                        <div class="role-fields" id="association-fields" style="display: none;">
                            <div class="form-group">
                                <label for="signup-association-name">Association Name</label>
                                <input type="text" id="signup-association-name" name="association_name" placeholder="Enter association name" value="<?php echo isset($_POST['association_name']) && isset($_POST['signup']) ? htmlspecialchars($_POST['association_name']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-license-no">Ministry of Transport License No.</label>
                                <input type="text" id="signup-license-no" name="license_no" placeholder="Enter license number" value="<?php echo isset($_POST['license_no']) && isset($_POST['signup']) ? htmlspecialchars($_POST['license_no']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-fleet-size">Estimated Fleet Size</label>
                                <input type="number" id="signup-fleet-size" name="fleet_size" placeholder="Enter estimated fleet size" min="1" value="<?php echo isset($_POST['fleet_size']) && isset($_POST['signup']) ? htmlspecialchars($_POST['fleet_size']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-manager-id">Manager ID</label>
                                <input type="text" id="signup-manager-id" name="manager_id" placeholder="Enter manager ID" value="<?php echo isset($_POST['manager_id']) && isset($_POST['signup']) ? htmlspecialchars($_POST['manager_id']) : ''; ?>">
                            </div>
                        </div>

                        <!-- Transitor Fields -->
                        <div class="role-fields" id="transitor-fields" style="display: none;">
                            <div class="form-group">
                                <label for="signup-transitor-license">Transitor License / ID</label>
                                <input type="text" id="signup-transitor-license" name="transitor_license" placeholder="Enter transitor license/ID" value="<?php echo isset($_POST['transitor_license']) && isset($_POST['signup']) ? htmlspecialchars($_POST['transitor_license']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-port-operation">Port of Operation</label>
                                <input type="text" id="signup-port-operation" name="port_operation" placeholder="Enter port of operation" value="<?php echo isset($_POST['port_operation']) && isset($_POST['signup']) ? htmlspecialchars($_POST['port_operation']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="signup-customs-agency">Customs Agency Code</label>
                                <input type="text" id="signup-customs-agency" name="customs_agency" placeholder="Enter customs agency code" value="<?php echo isset($_POST['customs_agency']) && isset($_POST['signup']) ? htmlspecialchars($_POST['customs_agency']) : ''; ?>">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Role switcher functionality for role-first authentication
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const signupIdentifier = document.getElementById('signup-identifier');
            ...
            roleOptions.forEach(option => {
                option.addEventListener('click', function() {
                    ...
                    // Update form placeholders and helper text based on role
                    ...
                    roleInput.id = 'selected_role_input';

                    // Remove existing role input if any
                    const existingInput = document.getElementById('selected_role_input');
                    if (existingInput) {
                        existingInput.remove();
                    }

                    // Add to both forms
                    loginForm.appendChild(roleInput.cloneNode(true));
            ...
            function updateFormForRole(role) {
                const roleLabels = {
                    'shipper': {
                        identifier: 'Email or Phone (Shipper Account)',
                        helper: 'Enter your shipper email or phone number'
                    },
                    'association': {
                        identifier: 'Email or Phone (Association Account)',
                        helper: 'Enter your association email or phone number'
                    },
                    'transitor': {
                        identifier: 'Email or Phone (Transitor Account)',
                        helper: 'Enter your transitor email or phone number'
                    }
                };
                ...
                // Update login form
                if (loginIdentifier) {
                    loginIdentifier.placeholder = labels.identifier;
                }

                // Update signup form
                if (signupIdentifier) {
                    signupIdentifier.placeholder = labels.identifier;
                }

                // Update helper text (you can add this element to the form)
                const helperText = document.getElementById('identifier-helper');
                if (helperText) {
                    helperText.textContent = labels.helper;
                }
            }
            ...
            // Initialize with default role (shipper)
            updateFormForRole('shipper');
            showRoleFields('shipper');

            // Create hidden input for default role
            let roleInput = document.createElement('input');
            roleInput.type = 'hidden';
            roleInput.name = 'selected_role';
            roleInput.value = 'shipper';
            roleInput.id = 'selected_role_input';
            signupForm.appendChild(roleInput);
        });
