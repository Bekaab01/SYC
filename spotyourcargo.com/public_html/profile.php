...
<head>
    ...
    <title>Spot Your Cargo - My Profile</title>
...
<body>
    ...
    <script>
        ...
        document.getElementById('profile-form').addEventListener('submit', function(e) {
            ...
            if (!valid) {
                e.preventDefault();
                dashboardModalSystem.showErrorModal('Please fill in all required fields correctly.');
            }
        });
        ...
        document.getElementById('password-form').addEventListener('submit', function(e) {
            ...
            if (!currentPassword || !newPassword || !confirmPassword) {
                e.preventDefault();
                dashboardModalSystem.showErrorModal('Please fill in all password fields.');
                return;
            }
            ...
            if (newPassword.length < 8) {
                e.preventDefault();
                dashboardModalSystem.showErrorModal('Password must be at least 8 characters long.');
                return;
            }
        });
