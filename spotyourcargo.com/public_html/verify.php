...
<head>
    ...
    <title>Email Verification - Spot Your Cargo</title>
    <style>
        body {
...
<body>
    <div class="verification-container">
        <?php if ($verification_result && $verification_result['success']): ?>
            ...
            <p>Your email address <strong><?php echo htmlspecialchars($verification_result['email']); ?></strong> has been successfully verified. You can now access all features of your Spot Your Cargo account.</p>
